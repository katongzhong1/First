...
//  _imageNode.contentMode = UIViewContentModeCenter;
  ...
  // lorem ipsum text, plus some nice styling  文本排版
  _textNode = [[ASTextNode alloc] init];
  _textNode.attributedString = [[NSAttributedString alloc] initWithString:[self kittyIpsum]
                                                               attributes:[self textStyle]];
    _textNode.layerBacked = YES;
    _textNode.shadowColor = [UIColor colorWithRed:0.136 green:0.128 blue:0.128 alpha:1.000].CGColor;
    _textNode.shadowOpacity = 3;
    _textNode.shadowOffset = CGSizeMake(2, 3);
    _textNode.shadowRadius = 5;
//    _textNode.shadowPadding = 2;
