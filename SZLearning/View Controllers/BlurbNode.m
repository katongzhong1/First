...
- (instancetype)init
{
  ...
  [string addAttributes:@{
                          ...
                          NSUnderlineStyleAttributeName: @(NSUnderlineStyleSingle | NSUnderlinePatternDashDotDot),
                          }
                  range:[blurb rangeOfString:@"placekitten.com"]];
  _textNode.attributedString = string;
    _textNode.truncationAttributedString = [[NSMutableAttributedString alloc] initWithString:@"esy"];
...
- (void)layout
{
  ...
  _textNode.frame = CGRectMake(roundf((self.calculatedSize.width - textNodeSize.width) / 2.0f),
    ...
    NSRange range = [@"kittens courtesy placekitten.com \U0001F638" rangeOfString:@"kittens"];
    _textNode.highlightRange = range;
}
